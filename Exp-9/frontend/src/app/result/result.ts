...
export class ResultComponent implements OnInit {
  ...
  getDetailedMessage(): string {
    const percentage = this.getPercentage();
    if (percentage >= 80) return 'Outstanding performance! You have mastered this topic.';
    if (percentage >= 60) return 'Good work! You have a solid understanding of the basics.';
